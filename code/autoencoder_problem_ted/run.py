...
verbose_rate  = 10
C             = 600.01    # injected noise variance parameter
eta           = 0.000001 # step size for Hamiltoniam dynamics
#h = 0.0005
...
if __name__ == "__main__":
  ...
  params["grad_params"]  = {"logs":{"true":[],"true_abc":[],"2side_keps":[],"2side_sl":[]},\
                            ...
                            "2side_keps": {"R": 5},"percent_to_change":0.25}
