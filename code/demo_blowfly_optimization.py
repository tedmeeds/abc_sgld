...
problem_params["epsilon"] = 0.01 #0.01 #10*np.array([1.0,1.0,0.5,0.5,0.5,0.1,0.01,0.5,2.0,1])
...
if __name__ == "__main__":
  ...
  #cs = [0.5,0.1,0.2,0.3]
  cs = [10*problem_params["epsilon"]] #np.array([0.5,0.1,0.1,0.5,0.01,0.1])]
  ...
  for c in cs:
    ...
    # for others
    alpha = 100*1e-1*problem_params["epsilon"] #*3*c/(4)
