...
if __name__ == "__main__": 
  ...
  if save_it:
    pp.savefig("exp_crn_figure.pdf", format="pdf", dpi=600,bbox_inches="tight")
    pp.savefig("../../papers/uai-2015/images/exp_crn_figure.pdf", format="pdf", dpi=600,bbox_inches="tight")
  pp.show()